...
jpTerminal.addCommand({
         name: 'find',
         summary: 'Finds a named file in the system',
         manPage: 'SYNOPSIS\n' +
                  '   find [FILE]\n' +
                  'DESCRIPTION\n' +
                  '   Finds a named file in the system.',
         command: function(env, inputLine) {
         var arg = inputLine.split(/ +/)[1] || '',
             output = '<span>Find: No File Specified</span>';
         ...
         if (arg.length > 0) {
            ...
            output = '<div>' + arg + '  NOT FOUND IN LIBRARIES </div>';
